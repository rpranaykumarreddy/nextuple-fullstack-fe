...
describe("TransactionTool & useTransactions fn()", () => {
    test("should render & success path", async () => {
        ...
        expect(global.fetch).toHaveBeenNthCalledWith(3,
            confirmTransactionAuthData.link + "/" + InitTransactionObject.transactionId + "?code=123456"
            , {
    ...
    test("should render & success path for cancel", async () => {
        ...
        expect(global.fetch).toHaveBeenNthCalledWith(3,
            cancelTransactionAuthData.link + "/" + InitTransactionObject.transactionId, {
    ...
    test("should render & fail at check Wallet trim part", async () => {
        ...
        await userEvent.tab();
        await waitFor(() => {
            screen.getByText("Username is empty");
        });
