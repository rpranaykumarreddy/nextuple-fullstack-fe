...
import {useConfirmTOTP, useGetInitTOTP, useRechargeWallet, useTransactions} from "../data/serverHooks";
import {useSelector} from "react-redux";
export default function TransactionTool({open, onClose}) {
    const [error,isLoading,initTransaction,confirmTransaction,cancelTransaction,checkWallet,data,setData,isWalletExists] = useTransactions();
    ...
    let content = (<><FormControl fullWidth margin="normal">
        <TextField
        ...
        />
        {isWalletExists === false && <FormHelperText>Wallet does not exist</FormHelperText>}
    </FormControl>
    ...
    if(initDone){
        content = (<><FormControl fullWidth margin="normal">
            <TextField
                label="TOTP"
                type="number"
                variant="outlined"
